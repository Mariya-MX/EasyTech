...
urlpatterns = [
   ...
   path('cancel/<int:availability_id>/', views.cancel_availability, name='cancel_availability'),
...
#    path('deactivate/', views.deactivate, name='deactivate'),
   ...
   path('generate-pdf/<int:product_id>/', views.generate_pdf, name='generate_pdf'),
